...
/**
 * Hilltop Smartlink Component
 *
 * Clickable ad that opens Hilltop advertiser link
 *
 * Props:
 ...
 */
const HilltopSmartlink = ({
  type = 'button',
  text = 'View More',
  className = ''
}) => {
  const smartlinkUrl = 'https://narrowdrawing.com/b.3/VJ0/Pt3XpNvvbemCVkJIZxDM0Y2oN/zgAKw_NpTxcpz/L/T_Yg3KMwDUAs1UNKzIQR';
...
export default HilltopSmartlink;
